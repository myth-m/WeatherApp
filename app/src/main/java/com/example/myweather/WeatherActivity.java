...
public class WeatherActivity extends AppCompatActivity {
    ...
    public String requestIp(){
        String ipUrl = "https://restapi.amap.com/v3/ip?key=4dcdff7c048a7e48fa5674b14725286d";
        HttpUtil.sendOkHttpRequest(ipUrl, new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                final String responseText = response.body().string();
                final ip ip = Utility.handleIpResponse(responseText);//解析相应的内容
    ...
    public void requestWeather(final String weatherId){
        ...
        String weatherUrl = "https://restapi.amap.com/v3/weather/weatherInfo?key=4dcdff7c048a7e48fa5674b14725286d&city=" + weatherId + "&extensions=all&output=JSON";
...
//                            Log.d(TAG, "run: " + responseText);
    ...
    public void requestNowWeather(final String weatherId){
        String weatherUrl = "https://restapi.amap.com/v3/weather/weatherInfo?key=4dcdff7c048a7e48fa5674b14725286d&city=" + weatherId + "&output=JSON";
        HttpUtil.sendOkHttpRequest(weatherUrl, new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                final String responseText = response.body().string();
